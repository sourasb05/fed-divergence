...
from src.client.FedMOON_KL_client import FedMOON_KL_Client
...
class FedMOON_KL_Server(Base_server):
    ...
    def __init__(self, args, model, loss, device, curr_dir):
        ...
        for i in range(0,total_users):
            ...
            user = FedMOON_KL_Client(args,i, model,loss,train,test,data_ratio,device, curr_dir)   # Creating the instance of the users. 
