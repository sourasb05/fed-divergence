...
def args_parser():
    ...
    parser.add_argument("--dataset", type=str, default="CIFAR10", choices=["CIFAR10", "EMNIST"])
    parser.add_argument("--model_name", type=str, default="CNN",  choices=["CNN", "MCLR"])
    ...
    parser.add_argument("--num_users", type=int, default=50, help="should be multiple of 10") 
    parser.add_argument("--num_users_perGR", type=int, default=50, help="should be <= num_users")
    parser.add_argument("--noise_level", type=float, default=0.2, help="should be in [0.1, 0.2, 0.4, 0.6, 0.8]")
